...
function renderStatus() {
  ...
  if (status.initialized) {
    ...
    elements.statusText.textContent = `项目路径：${status.root} | Provider 握手：${status.provider_handshake_ready_count || 0} 正常 / ${status.provider_handshake_failed_count || 0} 失败 | API 权限：${status.provider_api_verified_count || 0} 通过 / ${status.provider_api_failed_count || 0} 失败`;
